...
<form class="layui-form" action="/auth/user/add" method="post">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <<< range .roles >>>
      <input type="checkbox" name="roleIDs" title="<<< .Name >>>" value="<<< .ID >>>">
      <<< end >>>
    </div>
  </div>
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="checkbox" name="initState" lay-skin="switch">
    </div>
  </div>
